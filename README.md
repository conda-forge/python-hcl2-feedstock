...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-hcl2-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12784&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-hcl2-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-hcl2` can be installed with:

```
conda install python-hcl2
```

It is possible to list all of the versions of `python-hcl2` available on your platform with:
